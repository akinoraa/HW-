...
public:
    Scooter() : Transport("Scooter", 30, 2) {
...
public:
    Bus() : Transport("Bus", 60, 3) {

    }
};
class Tram : public Transport {
public:
    Tram() : Transport("Tram", 40, 2) {
...
public:
    Trolleybus() : Transport("Trolleybus", 35, 3) {
...
public:
    Minibus() : Transport("Minibus", 50, 4) {
...
public:
    Bicycle() : Transport("Bicycle", 20, 0.5) {
...
public:
    Airplane() : Transport("Airplane", 800, 10) {
